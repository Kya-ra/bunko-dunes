...
async def on_message(message):
    ...
    if (message.is_system() and message.type == discord.MessageType.new_member and message.guild.name in advanced_guilds) or msg == "bunko welcome debug a-go-go" or (msg == ".signup" and message.guild.name in advanced_guilds):
        ...
        content+="2. Send me (<@1276985438715904093>) your tcd.ie email address in a private Discord message, I'll check your membership, and then let you in!\n\n"
        ...
        content+="If you have any problems, message me (<@1276985438715904093>) or a committee member!
